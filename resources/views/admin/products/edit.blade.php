...
@section('content')
    ...
    <div class="dashboard-header">
        ...
        <a href="{{ route('admin.products.index') }}" class="btn-clean"
            style="width: auto; display: inline-block; text-decoration: none;"><i class='bx bx-arrow-back'></i>
            Retour
        </a>
    </div>
    ...
    <div class="card-box" style="max-width: 800px; margin: 0 auto;">
        <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div style="margin-bottom: 20px;">
                <label style="display: block; margin-bottom: 8px; font-weight: 500;">Stock Actuel</label>
            ...
            <div style="margin-bottom: 20px;">
                ...
                <textarea name="description" rows="4"
                    style="width: 100%; padding: 12px; border: 1px solid #e5e7eb; border-radius: 12px; font-size: 14px; outline: none; resize: vertical;">{{ old('description', $product->description) }}</textarea>
            </div>
